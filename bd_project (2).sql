...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29/04/2025 às 14:31
...
(120, 0, 'Marcelo Gonçalves', 5, 7),
(1112, 0, 'Ana Souza', 5, 9),
(1231, 0, 'Daniela Torres', 2, 9),
(1234, 0, 'João Silva', 3, 7),
(2223, 0, 'Luiza Martins', 4, 1),
(2342, 0, 'Renata Barros', 2, 3),
(3213, 0, 'Henrique Lopes', 6, 6),
(3335, 0, 'Gabriel Almeida', 7, 8),
(4445, 0, 'Bruno Santos', 6, 8),
(4564, 0, 'Lucas Rocha', 3, 1),
(5435, 0, 'André Monteiro', 6, 1),
(5556, 0, 'Carlos Pereira', 7, 3),
(6546, 0, 'Juliana Araújo', 1, 8),
(6667, 0, 'Rafaela Costa', 5, 3),
(7778, 0, 'Carla Mendes', 3, 5),
(7897, 0, 'Camila Freitas', 4, 5),
(8889, 0, 'Pedro Henrique', 1, 7),
(8907, 0, 'Patrícia Ribeiro', 7, 9),
(9876, 0, 'Maria Oliveira', 1, 5),
(9998, 0, 'Fernanda Lima', 2, 6);
